        ...
        {isLoading ? (
          ...
          <div className="w-full max-w-2xl text-left relative">
            <motion.h1 
              ...
              className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 text-foreground font-headline"
            >
              {content?.title}
            </motion.h1>
            <motion.p 
      ...
      <div className="flex flex-col md:flex-row gap-2">
        ...
        >
            ...
            <div className="absolute bottom-0 left-0 p-6 md:p-8">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-2 font-headline">{story.title}</h3>
        ...
        >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent" />
            <div className="absolute bottom-0 left-0 p-6 md:p-8">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-2 font-headline">{news.title}</h3>
