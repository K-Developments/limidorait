      ...
      <div className="container mx-auto px-4 md:px-6 pt-12">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center text-center py-12">
            ...
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-4 font-headline">
              {content?.aboutTitle}
            </h2>
          ...
          <div className="relative md:grid md:grid-cols-2 md:gap-8 md:items-center">
            ...
            >
              {isLoading ? (
                ...
                <>
                  <h3 className="text-3xl font-bold tracking-tight font-headline">{content?.conceptsTitle}</h3>
          ...
          <div className="flex flex-col-reverse md:relative md:grid md:grid-cols-2 md:gap-8 md:items-center">
            ...
            >
              {isLoading ? (
                ...
                <>
                  <h3 className="text-3xl font-bold tracking-tight font-headline">{content?.workflowTitle}</h3>
                  <p className="text-muted-foreground md:text-lg">
